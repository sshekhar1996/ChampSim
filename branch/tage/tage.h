...
#define TAGE_HISTORY_ALPHA 1.2
#define TAGE_RESET_USEFUL_INTERVAL 512000

const uint8_t TAGE_INDEX_BITS[TAGE_NUM_COMPONENTS] = {13,15,13,12};
const uint8_t TAGE_TAG_BITS[TAGE_NUM_COMPONENTS] = {10,11,13,14};
